...
{
	u32 *setPointPtr = (u32 *) (SM_DM_BASEADDR + SM_DM_SETPOINT_OFFSET);
	u32 *setDirPtr   = (u32 *) (SM_DM_BASEADDR + SM_DM_SETDIR_OFFSET);
	u32 *rpmPtr      = (u32 *) (SM_DM_BASEADDR + SM_DM_RPM_OFFSET);
	u32 *dirPtr      = (u32 *) (SM_DM_BASEADDR + SM_DM_DIR_OFFSET);
