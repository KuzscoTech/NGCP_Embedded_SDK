...
HD_PWD='C:/Users/george/Documents/local_projects/dryrun/dryrun.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ugv_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ugv_wrapper.tcl
