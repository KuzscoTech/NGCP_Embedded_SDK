...
HD_PWD='C:/Users/george/Documents/local_projects/dryrun/dryrun.runs/ugv_motorEncoder_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ugv_motorEncoder_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ugv_motorEncoder_0_0.tcl
