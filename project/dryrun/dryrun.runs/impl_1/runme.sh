...
HD_PWD='C:/Users/george/Documents/local_projects/dryrun/dryrun.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ugv_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ugv_wrapper.tcl -notrace
