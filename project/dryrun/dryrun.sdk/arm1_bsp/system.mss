...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = motorEncoder
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = motorEncoder_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = motorEncoder
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = motorEncoder_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = motorEncoder
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = motorEncoder_2
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = motorPWM
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = motorPWM_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = motorPWM
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = motorPWM_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = motorPWM
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = motorPWM_2
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = servoz3
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = servoz3_0
END
