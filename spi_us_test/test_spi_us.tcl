...
#
# test_spi_us.tcl: Tcl script for re-creating project 'test_spi_us(2)'
#
# Generated by Vivado on Sat Mar 12 00:38:51 -0800 2022
...
#
#    "C:/Users/george/Documents/NGCP_Embedded_SDK/spi_us_test/test_spi_us/test_spi_us.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"
#
# 3. The following remote source files that were added to the original project:-
#
#    "C:/Users/george/Documents/NGCP_Embedded_SDK/spi_us_test/constraints/spi_us.xdc"
#
#*****************************************************************************************
...
set _xil_proj_name_ "test_spi_us(2)"
...
set_property -name "ip_output_repo" -value "$proj_dir/test_spi_us.cache/ip" -objects $obj
set_property -name "mem.enable_memory_map_generation" -value "1" -objects $obj
set_property -name "sim.central_dir" -value "$proj_dir/test_spi_us.ip_user_files" -objects $obj
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/../DigilentIP"] [file normalize "$origin_dir/../HCSR04Bz_1.0"]" $obj
...
set file "[file normalize "$origin_dir/constraints/spi_us.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/constraints/spi_us.xdc"
...
proc cr_bd_design_1 { parentCell } {
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins HCSR04Bz_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins HCSR04Bz_1/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins HCSR04Bz_2/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M04_AXI [get_bd_intf_pins PmodGPS_0/AXI_LITE_UART] [get_bd_intf_pins ps7_0_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M05_AXI [get_bd_intf_pins PmodGPS_0/AXI_LITE_GPIO] [get_bd_intf_pins ps7_0_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M06_AXI [get_bd_intf_pins axi_quad_spi_1/AXI_LITE] [get_bd_intf_pins ps7_0_axi_periph/M06_AXI]
  ...
  connect_bd_net -net echo_sig_0_1 [get_bd_ports echo_sig_1] [get_bd_pins HCSR04Bz_1/echo_sig]
  connect_bd_net -net echo_sig_1_1 [get_bd_ports echo_sig_0] [get_bd_pins HCSR04Bz_0/echo_sig]
