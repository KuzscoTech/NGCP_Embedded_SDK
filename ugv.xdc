...
set_property -dict { PACKAGE_PIN L14   IOSTANDARD LVCMOS33 } [get_ports { mgm0_chA }]; #IO_L22P_T3_AD7P_35 Sch=JA2_R_P             
set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports { mgm0_chB }]; #IO_L24P_T3_AD15P_35 Sch=JA3_R_P            
...
set_property -dict { PACKAGE_PIN L15   IOSTANDARD LVCMOS33 } [get_ports { mgm1_chA }]; #IO_L22N_T3_AD7N_35 Sch=JA2_R_N             
set_property -dict { PACKAGE_PIN J16   IOSTANDARD LVCMOS33 } [get_ports { mgm1_chB }]; #IO_L24N_T3_AD15N_35 Sch=JA3_R_N            
...
##Pmod Header JC  
## -> MICROMETAL MOTOR                                                                                                                
#set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33     } [get_ports { chA_1 }]; #IO_L10P_T1_34 Sch=jc_p[1]   			 
...
##Pmod Header JD           
## -> UARTS                                                                                                       
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33     } [get_ports { UART_0_rxd }]; #IO_L5P_T0_34 Sch=jd_p[1]                  
set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33     } [get_ports { UART_1_rxd }]; #IO_L5N_T0_34 Sch=jd_n[1]				 
set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33     } [get_ports { UART_2_rxd }]; #IO_L6P_T0_34 Sch=jd_p[2]                  
#set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33     } [get_ports { jd[3] }]; #IO_L6N_T0_VREF_34 Sch=jd_n[2]             
set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33     } [get_ports { UART_0_txd }]; #IO_L11P_T1_SRCC_34 Sch=jd_p[3]            
set_property -dict { PACKAGE_PIN U15   IOSTANDARD LVCMOS33     } [get_ports { UART_1_txd }]; #IO_L11N_T1_SRCC_34 Sch=jd_n[3]            
set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33     } [get_ports { UART_2_txd }]; #IO_L21P_T3_DQS_34 Sch=jd_p[4]             
