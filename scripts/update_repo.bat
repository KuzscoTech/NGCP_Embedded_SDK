...
xcopy /s C:\Users\george\Documents\local_projects\dryrun\dryrun.sdk\microMetalSysId\src\microMetalSysId.c C:\Users\george\Documents\NGCP_Embedded_SDK\drivers\micrometal_motor /Y
